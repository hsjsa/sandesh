        ...
        with download_dict_lock:
            ...
            if uname is not None:
                ...
                if LOGS_CHATS:
                    try:
                        for i in LOGS_CHATS:
                            msg1 = f'<b>#Uploaded: </b> <code>{download_dict[self.uid].name()}</code>\n'
                            msg1 += f'\n<b>Size: </b> {size}\n'
                            msg1 += f'\n<b>By: </b>{uname}\n'
...
def _mirror(bot, update, isZip=False, extract=False, isQbit=False, isLeech=False, pswd=None):
    ...
    if bot_utils.is_gdrive_link(link):
        ...
        if BLOCK_MEGA_LINKS:
            sendMessage("𝐌𝐞𝐠𝐚 𝐋𝐢𝐧𝐤'𝐬 𝐀𝐫𝐞 𝐁𝐥𝐨𝐜𝐤𝐞𝐝 🚫. \n\n𝐈𝐟 𝐘𝐨𝐮 𝐖𝐚𝐧𝐭 𝐓𝐨 𝐌𝐢𝐫𝐫𝐨𝐫 𝐁𝐢𝐠 𝐅𝐢𝐥𝐞𝐬/𝐅𝐨𝐥𝐝𝐞𝐫 𝐅𝐫𝐨𝐦 𝐌𝐞𝐠𝐚, \n\n𝐓𝐡𝐞𝐧 𝐂𝐡𝐞𝐜𝐤𝐨𝐮𝐭 𝐑𝐞𝐡𝐚𝐧'𝐬 𝐆𝐫𝐨𝐮𝐩\n\n <a href='https://t.me/megamirror69'>ㅤ ㅤㅤ𝐌𝐞𝐠𝐚 𝐌𝐢𝐫𝐫𝐨𝐫</a>", bot, update)
            return
        link_type = bot_utils.get_mega_link_type(link)
        if link_type == "folder" and BLOCK_MEGA_FOLDER:
            sendMessage("𝐌𝐞𝐠𝐚 𝐅𝐨𝐥𝐝𝐞𝐫'𝐬 𝐀𝐫𝐞 𝐁𝐥𝐨𝐜𝐤𝐞𝐝 🚫. \n\n𝐈𝐟 𝐘𝐨𝐮 𝐖𝐚𝐧𝐭 𝐓𝐨 𝐌𝐢𝐫𝐫𝐨𝐫 𝐁𝐢𝐠 𝐅𝐢𝐥𝐞𝐬/𝐅𝐨𝐥𝐝𝐞𝐫 𝐅𝐫𝐨𝐦 𝐌𝐞𝐠𝐚, \n\n𝐓𝐡𝐞𝐧 𝐂𝐡𝐞𝐜𝐤𝐨𝐮𝐭 𝐑𝐞𝐡𝐚𝐧'𝐬 𝐆𝐫𝐨𝐮𝐩\n\n <a href='https://t.me/megamirror69'>ㅤ ㅤㅤ𝐌𝐞𝐠𝐚 𝐌𝐢𝐫𝐫𝐨𝐫</a>", bot, update)
        else:
